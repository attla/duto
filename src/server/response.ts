...
export default class $Response {
  ...
  static badRequest(errors?: Errors | null, msg?: string, headers?: HeaderRecord): Response
  static badRequest(errors?: Errors | null, msg?: string, headers?: HeaderRecord) {
  ...
  static conflict(errors?: Errors | null, msg?: string, headers?: HeaderRecord) {
    return this.error(errors, msg, 409, headers)
  }

  static unsupportedMediaType(): Response
  static unsupportedMediaType(errors?: Errors | null, msg?: string, headers?: HeaderRecord) {
    return this.error(errors, msg, 415, headers)
  }

  static internalError(): Response
  static internalError(errors?: Errors | null, msg?: string, headers?: HeaderRecord) {
    return this.error(errors, msg, 500, headers)
  }

  static error(errors?: Errors | null, msg?: string, status?: ContentfulStatusCode, headers?: HeaderRecord) {
    status ??= 500
    if (!errors && !msg)
